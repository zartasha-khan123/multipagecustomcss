...
function BestSelling() {
    const [emblaRef, emblaApi] = useEmblaCarousel({ loop: true, slidesToScroll: 1, dragFree: true }, [Autoplay({
        delay: 2000,
    ...
    return (
        <div className={styles.wrapper}>
            <div className={styles.whatsnew}>
                <h1 className={styles.whatsnewTitle}>WHATS NEW</h1>
                <div className={styles.whatsnewImages}>
                    <Image src='/images/download (2).png' width={300} height={100} alt='arrow' />
                    <Image src='/images/download (3).png' width={300} height={100} alt='arrow' />
                    <Image src='/images/images.png' width={300} height={100} alt='arrow' />
                </div>
            </div>
            ...
            <section className={styles.bestselling}>
                ...
                <div className={styles.centerul}>
                    <ul className={styles.ul}>
                        <li>NEW ARRIVALS</li>
                        <li className={styles.activeItem}>SALES</li>
                        <li>ACCESSORIES</li>
                    </ul>
                </div>
                    ...
                    <div className={styles.embla_container}>
                        {CardData.map((data) => {
                            return (
                                <div className={styles.embla_slide} key={data.id}>
                                    <div className={styles.imgdiv} style={{ backgroundColor: data.backgroundColor }}>
                                        <Image src={data.src} width={371} height={606} alt='product' className={styles.cardimgs} />
                                    </div>
                                    <div className={styles.textdiv}>
                                        <h1 className={aBeeZee.className}>{data.heading}</h1>
                                        <div className={styles.price}>
